...
namespace iysy.JustCut
{
    ...
    public class PlayerLockController : MonoBehaviour
    {
        ...
        {
            //Debug.Log("获取右边的方向" + transform.right.x);
            var faceDir = flipFaceDir ? -transform.right.x : transform.right.x;
            //Debug.Log(this.gameObject.name+"获取朝向"+ faceDir);
        ...
        public bool NeedFilp
        {
            get => GetPosRelationship() != GetFaceDir();
        }
