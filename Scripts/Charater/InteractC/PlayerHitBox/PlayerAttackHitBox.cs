...
namespace iysy.JustCut
{
    ...
    public class PlayerAttackHitBox:MonoBehaviour
    {
        ...
        bool just;
        int chargeCount;
        public void SetAttackDataModel(bool just,int chargeCount)
        {
            this.just = just;
        ...
        public void SetGPEnable(bool enable)
        {
            if (enable)
            {
                //Debug.Log(this.gameObject + "设置激活GP");
            ...
            else
            {
                ...
                {
                    //Debug.Log(this.gameObject + "设置取消激活GP");
                    try
                    {
                    ...
                    {
                        throw new System.Exception("新场景创建时，旧场景仍在运行脚本?!");
                    }
                }
            }
        }
        public void SetHitEnable(bool enable)
        {
            ...
            if (enable)
            {
                if (isGpActive == false)
                    this.gameObject.SetActive(true);
                isHitActive = enable;
                interactC.PlayWaveSound(attackData.GetFinalIntensity());
            }
            else
            {
                isHitActive = enable;
